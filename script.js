...
// YouTube Radyo kanallarını ekle
        const radioChannels = [
             { name: 'd1', url: 'https://www.youtube.com/watch?v=0RziZxRimS0' },
            { name: "d2", url: 'https://www.youtube.com/watch?v=j6n_EFtyi5s' },
            { name: 'd3', url: 'https://www.youtube.com/watch?v=fYOXs7pjirA' }
        ];
